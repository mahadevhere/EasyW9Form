...
export default function PrivacyPage() {
  return (
    <div className="container" style={{ paddingTop: 120, paddingBottom: 80, maxWidth: 800 }}>
      <h1 style={{ fontSize: 42, fontWeight: 900, marginBottom: 12 }}>Privacy Policy</h1>
      ...
      <div style={{ lineHeight: 1.8, fontSize: '15px' }}>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>1. Zero-Data-Storage Architecture</h2>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>2. Information We Collect</h2>
        <p>We collect only the minimum information necessary to provide our service and comply with legal obligations:</p>
        
        <h3 style={{ fontSize: 18, marginTop: 24, marginBottom: 12 }}>2.1 Information You Provide</h3>
        <ul>
        ...
        <h3 style={{ fontSize: 18, marginTop: 24, marginBottom: 12 }}>2.2 Automatically Collected Information</h3>
        <ul>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>3. How We Use Your Information</h2>
        <ul>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>4. Third-Party Services</h2>
        ...
        <ul>
          ...
          <li><strong>Mailjet</strong> — Transactional email delivery (<a href="https://www.mailjet.com/privacy-policy/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--primary)' }}>Mailjet Privacy Policy</a>)</li>
          <li><strong>MongoDB Atlas</strong> — Database hosting for non-sensitive metadata (email, payment status, IP addresses only)</li>
        </ul>

        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>5. Data Security</h2>
        <ul>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>6. Cookies & Tracking</h2>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>7. Data Retention</h2>
        <ul>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>8. Your Rights</h2>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>9. Children&apos;s Privacy</h2>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>10. Changes to This Policy</h2>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>11. Contact Us</h2>
        <p>
