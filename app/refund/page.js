...
export default function RefundPage() {
  return (
    <div className="container" style={{ paddingTop: 120, paddingBottom: 80, maxWidth: 800 }}>
      <h1 style={{ fontSize: 42, fontWeight: 900, marginBottom: 12 }}>Refund Policy</h1>
      ...
      <div style={{ lineHeight: 1.8, fontSize: '15px' }}>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>1. No-Refund Policy</h2>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>2. Exceptions — When We May Issue a Refund</h2>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>3. What Is NOT Eligible for a Refund</h2>
        <ul>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>4. How to Request a Refund</h2>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>5. Chargebacks & Disputes</h2>
        ...
        <h2 style={{ fontSize: 22, marginTop: 40, marginBottom: 16 }}>6. Contact Us</h2>
        <p>
